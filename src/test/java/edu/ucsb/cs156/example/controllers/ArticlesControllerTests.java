...
public class ArticlesControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_articles() throws Exception {
                ...
                Articles article2 = Articles.builder()
                                .title("Using testing-playground with Java Testing Library")
                                .url("https://dev.to/katieraby/using-testing-playground-with-java-testing-library-26j7")
                                .explanation("Helpful when we get to back end development")
                                .email("phtcon@ucsb.edu")
                                .dateAdded(ldt2)
                                .build();
